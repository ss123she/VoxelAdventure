...
Clone, run in Unity and open scene (VoxelAdventure/Scenes/SampleScene)

## 🙏 Acknowledgements

This project uses the following open source software:

- [fastNaiveSurfaceNets](https://github.com/bigos91/fastNaiveSurfaceNets) - licensed under the MIT License.
